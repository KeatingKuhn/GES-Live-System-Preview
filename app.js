...
(() => {
  ...
  function Canvas({ a, stepIdx, activeSteps, onEditStep }) {
    ...
    const [heatSubMode, setHeatSubMode] = React.useState("hp");
    ...
    function BlowerWheel({ cx, cy, r, spd, active }) {
      ...
      const blades = Array.from({ length: 16 }, (_, i) => {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          {
            key: i,
            x1: cx + r * 0.36 * Math.cos(ang),
            y1: cy + r * 0.36 * Math.sin(ang),
            x2: cx + r * 0.88 * Math.cos(ang + 0.22),
            y2: cy + r * 0.88 * Math.sin(ang + 0.22),
            stroke: active ? G + ".7)" : G + ".2)",
            strokeWidth: "1.9",
            strokeLinecap: "round"
          }
        );
      });
      return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement("circle", { cx, cy, r: r + 4, fill: "rgba(0,0,0,.5)", stroke: S + ".4)", strokeWidth: "0.8" }), /* @__PURE__ */ React.createElement("circle", { cx, cy, r, fill: "#050505", stroke: G + ".3)", strokeWidth: "0.9" }), active ? /* @__PURE__ */ React.createElement("g", { className: "spin", style: { transformBox: "fill-box", transformOrigin: "center", animationDuration: 1 / spd + "s" } }, blades) : /* @__PURE__ */ React.createElement("g", null, blades), /* @__PURE__ */ React.createElement("circle", { cx, cy, r: r * 0.27, fill: "#090909", stroke: G + ".34)", strokeWidth: "0.9" }), /* @__PURE__ */ React.createElement("circle", { cx, cy, r: r * 0.1, fill: "#111", stroke: G + ".42)", strokeWidth: "0.6" }));
    }
    ...
    function ACoilH({ x, y, w, h, active }) {
      ...
      return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement(
        ...
        return /* @__PURE__ */ React.createElement("g", { key: i }, /* @__PURE__ */ React.createElement("ellipse", { cx: tx, cy: ty, rx: 4, ry: 2, fill: active ? evapC + "22" : "rgba(14,14,34,.8)", stroke: tc, strokeWidth: "0.9", transform: `rotate(-22,${tx},${ty})` }), active && /* @__PURE__ */ React.createElement("circle", { cx: tx, cy: ty, r: 1.6, fill: evapC, opacity: "0.7", className: "glow-pulse", style: { animationDelay: i * 0.1 + "s" } }));
      }), Array.from({ length: n }, (_, i) => {
        const t = (i + 0.5) / n, tx = x + (peakX - x) * t + 3, ty = y + h + (peakY - (y + h)) * t - 3;
        return /* @__PURE__ */ React.createElement("g", { key: i }, /* @__PURE__ */ React.createElement("ellipse", { cx: tx, cy: ty, rx: 4, ry: 2, fill: active ? evapC2 + "22" : "rgba(14,14,34,.8)", stroke: active ? evapC2 : tc, strokeWidth: "0.9", transform: `rotate(22,${tx},${ty})` }), active && /* @__PURE__ */ React.createElement("circle", { cx: tx, cy: ty, r: 1.6, fill: evapC2, opacity: "0.7", className: "glow-pulse", style: { animationDelay: (i + n) * 0.1 + "s" } }));
      }), /* @__PURE__ */ React.createElement("circle", { cx: peakX - 5, cy: peakY + 4, r: 5.5, fill: "#06061c", stroke: active ? evapC : G + ".3)", strokeWidth: "1.3" }), active && /* @__PURE__ */ React.createElement("circle", { cx: peakX - 5, cy: peakY + 4, r: 2.5, fill: evapC, opacity: "0.85", className: "glow-pulse" }), /* @__PURE__ */ React.createElement("rect", { x, y: y + h, width: w, height: 6, rx: "1", fill: "#08121e", stroke: B + ".2)", strokeWidth: "0.7" }), hasUV && (() => {
    ...
    function ACoilV({ x, y, w, h, active }) {
      ...
      ), Array.from({ length: 12 }, (_, i) => /* @__PURE__ */ React.createElement("line", { key: i, x1: x + w * (i + 0.5) / 12, y1: y + 4, x2: x + w * (i + 0.5) / 12, y2: y + h - 4, stroke: W + ".04)", strokeWidth: "0.4" })), Array.from({ length: n }, (_, i) => {
        const t = (i + 0.5) / n, tx = x + (peakX - x) * t + 3, ty = y + h + (peakY - (y + h)) * t + 3;
        return /* @__PURE__ */ React.createElement("g", { key: i }, /* @__PURE__ */ React.createElement("ellipse", { cx: tx, cy: ty, rx: 4, ry: 2, fill: active ? evapC + "22" : "rgba(14,14,34,.8)", stroke: tc, strokeWidth: "0.9", transform: `rotate(${Math.atan2(peakY - (y + h), peakX - x) * 180 / Math.PI},${tx},${ty})` }), active && /* @__PURE__ */ React.createElement("circle", { cx: tx, cy: ty, r: 1.6, fill: evapC, opacity: "0.7", className: "glow-pulse", style: { animationDelay: i * 0.11 + "s" } }));
      }), Array.from({ length: n }, (_, i) => {
        const t = (i + 0.5) / n, tx = x + w + (peakX - (x + w)) * t - 3, ty = y + h + (peakY - (y + h)) * t + 3;
        return /* @__PURE__ */ React.createElement("g", { key: i }, /* @__PURE__ */ React.createElement("ellipse", { cx: tx, cy: ty, rx: 4, ry: 2, fill: active ? evapC2 + "22" : "rgba(14,14,34,.8)", stroke: active ? evapC2 : tc, strokeWidth: "0.9", transform: `rotate(${Math.atan2(peakY - (y + h), peakX - (x + w)) * 180 / Math.PI},${tx},${ty})` }), active && /* @__PURE__ */ React.createElement("circle", { cx: tx, cy: ty, r: 1.6, fill: evapC2, opacity: "0.7", className: "glow-pulse", style: { animationDelay: (i + n) * 0.11 + "s" } }));
      }), /* @__PURE__ */ React.createElement("circle", { cx: peakX + 4, cy: peakY + 6, r: 5.5, fill: "#06061c", stroke: active ? evapC : G + ".3)", strokeWidth: "1.3" }), active && /* @__PURE__ */ React.createElement("circle", { cx: peakX + 4, cy: peakY + 6, r: 2.5, fill: evapC, opacity: "0.85", className: "glow-pulse" }), /* @__PURE__ */ React.createElement("rect", { x, y: y + h, width: w, height: 6, rx: "1", fill: "#08121e", stroke: B + ".2)", strokeWidth: "0.7" }), hasUV && (() => {
        const rodCX = x + w * 0.5;
      ...
      return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement(
        ...
        return /* @__PURE__ */ React.createElement(
          "path",
          {
            ...
            fill: "none",
            stroke: active ? "rgba(249,115,22,.6)" : "rgba(108,44,8,.22)",
            strokeWidth: "2.8",
            strokeLinecap: "round"
          }
        );
    ...
    if (isAttic) {
      ...
      return /* @__PURE__ */ React.createElement("div", { ref: wrapRef, style: { position: "absolute", inset: 0 } }, hasCoil && /* @__PURE__ */ React.createElement(ToggleUI, { style: { position: "absolute", top: 8, right: 8, zIndex: 10 } }), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${VW} ${VH}`, preserveAspectRatio: "xMidYMid meet", className: "canvas-svg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement(Defs, null), /* @__PURE__ */ React.createElement("rect", { x: "0", y: "0", width: VW, height: VH, fill: "#0b0d14" }), hasCond && /* @__PURE__ */ React.createElement(
        "rect",
        {
          x: EXT_WALL_X,
          y: "0",
      ...
      }), /* @__PURE__ */ React.createElement("text", { x: RIDGE_X, y: RIDGE_Y + 24, textAnchor: "middle", fill: "rgba(232,236,246,.5)", fontSize: "12", fontFamily: "monospace" }, "SPRAY FOAM - SEALED ATTIC")) : /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement("rect", { x: "0", y: DECK_Y - 22, width: HOUSE_W, height: 24, fill: "rgba(255,130,170,.18)", stroke: "rgba(255,140,180,.08)", strokeWidth: "0.5" }), Array.from({ length: Math.floor(HOUSE_W / 17) }, (_, i) => /* @__PURE__ */ React.createElement(
        "ellipse",
        {
          key: i,
          cx: 8 + i * 17,
      ...
      )), /* @__PURE__ */ React.createElement("text", { x: RIDGE_X, y: RIDGE_Y + 24, textAnchor: "middle", fill: "rgba(255,182,193,.55)", fontSize: "12", fontFamily: "monospace" }, "FIBERGLASS INSULATION"))), /* @__PURE__ */ React.createElement("rect", { x: "0", y: DECK_Y, width: HOUSE_W, height: "5", fill: "#1c1e28", stroke: "rgba(200,196,172,.22)", strokeWidth: "0.4" }), Array.from({ length: Math.floor(HOUSE_W / 68) }, (_, i) => /* @__PURE__ */ React.createElement(
        "rect",
        {
          key: i,
          x: 38 + i * 68,
        ...
        ), !isExisting && (isMetal ? Array.from({ length: Math.floor(SUP_PLEN_H / 8) }, (_, i) => /* @__PURE__ */ React.createElement(
          "line",
          {
            key: i,
            x1: SUP_X + 2,
            y1: SUP_PLEN_Y + 4 + i * 8,
            x2: SUP_X + SUP_PLEN_W - 2,
            y2: SUP_PLEN_Y + 4 + i * 8,
            stroke: W + ".04)",
            strokeWidth: "0.3"
          }
        )) : Array.from({ length: Math.floor(SUP_PLEN_H / 10) }, (_, i) => /* @__PURE__ */ React.createElement(
          "line",
          {
            key: i,
            x1: SUP_X + 3,
            y1: SUP_PLEN_Y + 5 + i * 10,
            x2: SUP_X + SUP_PLEN_W - 3,
            y2: SUP_PLEN_Y + 5 + i * 10,
            stroke: G + ".07)",
            strokeWidth: "0.6"
          }
        ))), /* @__PURE__ */ React.createElement(
        ...
        const FAN = 36;
        const grille = (cx) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: cx - GW / 2, y: DECK_Y, width: GW, height: 9, rx: "1", fill: "rgba(0,0,0,.75)", stroke: DC, strokeWidth: "1.2" }), Array.from({ length: 5 }, (_, j) => /* @__PURE__ */ React.createElement(
          "line",
          {
            key: j,
            x1: cx - GW / 2 + 3 + j * (GW - 6) / 4,
            y1: DECK_Y + 1,
            x2: cx - GW / 2 + 3 + j * (GW - 6) / 4,
            y2: DECK_Y + 8,
            stroke: DC,
            strokeWidth: "0.8"
          }
        )), /* @__PURE__ */ React.createElement("text", { x: cx, y: DECK_Y + 18, textAnchor: "middle", fill: G + ".35)", fontSize: "11", fontFamily: "monospace" }, "SUPPLY"));
        ...
        const straight = (cx, key) => /* @__PURE__ */ React.createElement("g", { key }, /* @__PURE__ */ React.createElement("rect", { x: cx - DW / 2, y: pBot, width: DW, height: Math.max(0, DECK_Y - pBot), fill: DC, stroke: DS, strokeWidth: "1" }), DECK_Y - pBot > 10 && ductArrow(`M${cx},${pBot + 3} L${cx},${DECK_Y - 4}`, "arrow"), grille(cx));
    ...
    if (isCloset) {
      ...
      return /* @__PURE__ */ React.createElement("div", { ref: wrapRef, style: { position: "absolute", inset: 0 } }, hasCoil && /* @__PURE__ */ React.createElement(ToggleUI, { style: { position: "absolute", top: 8, right: 8, zIndex: 10 } }), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${VW} ${VH}`, className: "canvas-svg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement(Defs, null), /* @__PURE__ */ React.createElement("rect", { x: "0", y: "0", width: VW, height: VH, fill: "#0b0d14" }), hasCond && /* @__PURE__ */ React.createElement(
        "rect",
        {
          x: HOUSE_W,
          y: "0",
        ...
        ), !isExisting && isMetal && Array.from({ length: Math.floor(PLEN_TOTAL / 8) }, (_, i) => /* @__PURE__ */ React.createElement(
          "line",
          {
            key: i,
            x1: UNIT_X + 2,
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: leftDropX, y: exitY, width: UNIT_X - leftDropX, height: DW, fill: DC, stroke: DS, strokeWidth: "1" }), /* @__PURE__ */ React.createElement("rect", { x: leftDropX, y: exitY, width: DW, height: DECK_Y - exitY, fill: DC, stroke: DS, strokeWidth: "1" }), ductArrow(`M${UNIT_X - 3},${exitY + DW / 2} L${leftDropX + DW / 2},${exitY + DW / 2} L${leftDropX + DW / 2},${DECK_Y - 4}`, "la"), /* @__PURE__ */ React.createElement(
          "rect",
          {
            x: leftDropX - GW / 2 + DW / 2,
            y: DECK_Y,
            width: GW,
            height: 9,
            rx: "1",
          ...
          {
            key: i,
            x1: leftDropX - GW / 2 + DW / 2 + 3 + i * (GW - 6) / 4,
            y1: DECK_Y + 1,
            x2: leftDropX - GW / 2 + DW / 2 + 3 + i * (GW - 6) / 4,
            y2: DECK_Y + 8,
            stroke: DC,
            strokeWidth: "0.8"
          }
          ...
          "SUPPLY"
        ), /* @__PURE__ */ React.createElement("rect", { x: UNIT_X + PLEN_W, y: exitY, width: rightDropX - (UNIT_X + PLEN_W) + DW, height: DW, fill: DC, stroke: DS, strokeWidth: "1" }), /* @__PURE__ */ React.createElement("rect", { x: rightDropX, y: exitY, width: DW, height: DECK_Y - exitY, fill: DC, stroke: DS, strokeWidth: "1" }), ductArrow(`M${UNIT_X + PLEN_W + 3},${exitY + DW / 2} L${rightDropX + DW / 2},${exitY + DW / 2} L${rightDropX + DW / 2},${DECK_Y - 4}`, "ra"), /* @__PURE__ */ React.createElement(
          "rect",
          {
            x: rightDropX - GW / 2 + DW / 2,
            y: DECK_Y,
            width: GW,
            height: 9,
            rx: "1",
          ...
          {
            key: i,
            x1: rightDropX - GW / 2 + DW / 2 + 3 + i * (GW - 6) / 4,
            y1: DECK_Y + 1,
            x2: rightDropX - GW / 2 + DW / 2 + 3 + i * (GW - 6) / 4,
            y2: DECK_Y + 8,
            stroke: DC,
            strokeWidth: "0.8"
          }
        ...
        "path",
        {
          ...
          fill: "none",
          stroke: furnaceActive ? "rgba(249,115,22,.56)" : "rgba(108,44,8,.18)",
          strokeWidth: "2.6",
          strokeLinecap: "round"
        }
      )), /* @__PURE__ */ React.createElement(
  ...
  function App() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "site-header-spacer no-print" }), /* @__PURE__ */ React.createElement("div", { ref: topRef, className: "app-root" }, resumePending && /* @__PURE__ */ React.createElement("div", { className: "fadein", style: { position: "absolute", inset: 0, zIndex: 40, background: "var(--bk)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, padding: 24, textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { className: "splash-logo", style: { fontSize: "clamp(28px,6vw,44px)" } }, "WELCOME BACK"), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--fb)", fontSize: 15, color: "rgba(255,255,255,.6)", maxWidth: 420, lineHeight: 1.6 } }, (() => {
    ...
    ) : null))), pricingFlow !== null && /* @__PURE__ */ React.createElement("div", { style: { width: "100%", marginBottom: 12 } }, pricingFlow === "sizing" && (() => {
      ...
      const canSubNext = subId === "systems" ? !!pricingAnswers.systemsCount : subId === "sqft" ? !!pricingAnswers.tonnageChoice : subId === "ducts" ? pricingAnswers.wantDucts === false || pricingAnswers.wantDucts === true && pricingAnswers.ventCount > 0 : true;
      const left = /* @__PURE__ */ React.createElement("div", { className: isAtticMode ? "pricing-substep-left" : void 0, style: { flex: isAtticMode ? "0 0 420px" : "1 1 auto" } }, subId === "systems" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: isAtticMode ? 13 : "var(--fs-pricing-q)", fontWeight: 600, marginBottom: 4, fontFamily: "var(--ft)" } }, "How many separate HVAC systems does your home have?"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isAtticMode ? 10.5 : 12, color: "var(--mut)", lineHeight: isAtticMode ? 1.3 : 1.5 } }, "This is typically the number of thermostats you have, or the number of outdoor condenser units.")), subId === "sqft" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: isAtticMode ? 13 : "var(--fs-pricing-q)", fontWeight: 600, marginBottom: isAtticMode ? 2 : 4, lineHeight: isAtticMode ? 1.15 : "normal", fontFamily: "var(--ft)" } }, pricingAnswers.systemsCount === "1" ? "What size system does this home need?" : "What size system is needed for this part of your home?"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: isAtticMode ? 10.5 : 12, color: "var(--mut)", marginBottom: isAtticMode ? 3 : 8, lineHeight: isAtticMode ? 1.15 : 1.5 } }, isAtticMode ? "Pick the tonnage for your home's sq ft, or enter it below for a suggestion." : /* @__PURE__ */ React.createElement(React.Fragment, null, pricingAnswers.systemsCount === "1" ? "Pick the tonnage that best fits your home\u2019s total square footage." : "Pick the tonnage for just the area this system covers - not the whole home.", " Not sure? Enter your sq ft for a suggested starting point.")), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "number",
          min: "200",
      ...
      const right = /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, subId === "systems" && /* @__PURE__ */ React.createElement("div", { className: isAtticMode ? "pricing-opts-systems" : void 0, style: { display: "grid", gridTemplateColumns: isAtticMode ? "repeat(3,1fr)" : "repeat(auto-fit,minmax(150px,1fr))", gap: 6 } }, [{ v: "1", label: "Just 1 - this one" }, { v: "2", label: "2 systems" }, { v: "3+", label: "3 or more" }].map((o) => /* @__PURE__ */ React.createElement("button", { key: o.v, className: "opt" + (isAtticMode ? " opt-compact" : "") + (pricingAnswers.systemsCount === o.v ? " sel" : ""), onClick: () => setPricingAnswers((p) => ({ ...p, systemsCount: o.v })) }, /* @__PURE__ */ React.createElement("div", { className: "opt-inner" }, /* @__PURE__ */ React.createElement("div", { className: "opt-body" }, /* @__PURE__ */ React.createElement("span", { className: "opt-label" }, o.label)))))), subId === "sqft" && (() => {
