...
(() => {
  ...
  function Confetti({ count = 46 }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none", zIndex: 50 }, "aria-hidden": "true" }, pieces.map((p) => /* @__PURE__ */ React.createElement("span", { key: p.id, style: {
      position: "absolute",
      top: -14,
      left: p.left + "%",
      width: p.size,
