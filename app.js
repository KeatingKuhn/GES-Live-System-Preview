  ...
  function Canvas({ a, stepIdx, activeSteps, onEditStep, lang: lang2 }) {
    ...
    if (isAttic) {
      ...
      return /* @__PURE__ */ React.createElement(HoverCtx.Provider, { value: setHoverPart }, /* @__PURE__ */ React.createElement(GroupCtx.Provider, { value: groupApi }, /* @__PURE__ */ React.createElement("div", { ref: wrapRef, style: { position: "absolute", inset: 0 } }, hasCoil && /* @__PURE__ */ React.createElement(ToggleUI, { style: { position: "absolute", top: 8, right: 8, zIndex: 10 }, compactToggle, isDualFuel, hasFurnace, heatMode, heatSubMode, setHeatMode, setHeatSubMode, monthName: CURRENT_MONTH_NAME, lang: lang2 }), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${VW} ${VH}`, preserveAspectRatio: "xMidYMid meet", className: "canvas-svg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("rect", { x: "0", y: "0", width: VW, height: VH, fill: "#0b0d14" }), hasCond && /* @__PURE__ */ React.createElement(
        ...
        const ductArrow = (d, key, len) => /* @__PURE__ */ React.createElement(
          "path",
          {
            key,
            d,
            ...
            strokeLinejoin: "round",
            className: "airflow",
            style: { strokeDashoffset: 0, strokeDasharray: "16 10", animationDuration: BASE_DUR * (len / midLen) + "s" },
            markerEnd: "url(#arr)"
          }
        );
        const straight = (cx, key) => /* @__PURE__ */ React.createElement("g", { key }, /* @__PURE__ */ React.createElement("rect", { x: cx - DW / 2, y: pBot, width: DW, height: Math.max(0, DECK_Y - pBot), fill: DC, stroke: DS, strokeWidth: "1" }), /* @__PURE__ */ React.createElement(DuctRibbing, { x: cx - DW / 2, y: pBot, w: DW, h: Math.max(0, DECK_Y - pBot), vertical: true }), /* @__PURE__ */ React.createElement(DuctClamp, { x: cx - DW / 2, y: pBot + 2, w: DW, vertical: true }), /* @__PURE__ */ React.createElement(DuctClamp, { x: cx - DW / 2, y: DECK_Y - 5, w: DW, vertical: true }), DECK_Y - pBot > 10 && ductArrow(`M${cx},${pBot + 3} L${cx},${DECK_Y - 4}`, "arrow", midLen), /* @__PURE__ */ React.createElement(
          HoverInfo,
          {
            x: cx - DW / 2 - 2,
            y: pBot,
        ...
        const angled = (topX, dir, key) => {
          ...
          return /* @__PURE__ */ React.createElement("g", { key }, /* @__PURE__ */ React.createElement("rect", { x: topX - DW / 2, y: pBot, width: DW, height: STUB, fill: DC, stroke: DS, strokeWidth: "1" }), /* @__PURE__ */ React.createElement(DuctRibbing, { x: topX - DW / 2, y: pBot, w: DW, h: STUB, vertical: true }), /* @__PURE__ */ React.createElement("path", { d, fill: "none", stroke: DS, strokeWidth: DW + 2, strokeLinejoin: "round", strokeLinecap: "square" }), /* @__PURE__ */ React.createElement("path", { d, fill: "none", stroke: DC, strokeWidth: DW, strokeLinejoin: "round", strokeLinecap: "square" }), /* @__PURE__ */ React.createElement(DuctRibbingPath, { x1: topX, y1: pBot + STUB, x2: botX, y2: bendY, width: DW - 1 }), /* @__PURE__ */ React.createElement(DuctRibbingPath, { x1: botX, y1: bendY, x2: botX, y2: DECK_Y - 4, width: DW - 1 }), /* @__PURE__ */ React.createElement(DuctClamp, { x: topX - DW / 2, y: pBot + STUB - 2, w: DW, vertical: true }), /* @__PURE__ */ React.createElement(DuctClamp, { x: botX - DW / 2, y: DECK_Y - 5, w: DW, vertical: true }), ductArrow(arrowD, "arrow", pxLen(arrowPts)), /* @__PURE__ */ React.createElement(
            HoverInfo,
            {
