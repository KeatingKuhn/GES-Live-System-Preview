...
(() => {
  ...
  function ToggleUI({ style, compactToggle, isDualFuel, hasFurnace, heatMode, heatSubMode, setHeatMode, setHeatSubMode, monthName }) {
    if (compactToggle) {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "no-print", title: "Not a control - tap to see how this system behaves in each mode", style: { display: "flex", background: "#0c0c0c", border: "1px solid rgba(215,183,64,.22)", borderRadius: 3, overflow: "hidden", ...style } }, modes.map(
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "fadein no-print", title: "Not a control - click to see how this system behaves in each mode", style: { display: "flex", flexDirection: "column", background: "#0c0c0c", border: "1px solid rgba(215,183,64,.22)", overflow: "hidden", ...style } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 10px", fontFamily: "monospace", fontSize: "var(--fs-toggle-eyebrow)", letterSpacing: ".06em", color: "rgba(215,183,64,.75)", textAlign: "right", borderBottom: "1px solid rgba(215,183,64,.18)" } }, "\u25B8 preview how your system runs"), /* @__PURE__ */ React.createElement("button", { onClick: () => setHeatMode(false), style: {
      padding: "8px 14px",
      border: "none",
      cursor: "pointer",
      fontFamily: "monospace",
    ...
    return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement(
      ...
      return /* @__PURE__ */ React.createElement(
        HoverInfo,
        {
          ...
          vw,
          vh,
          title: partInfo("uv_light", lang).title,
          text: partInfo("uv_light", lang).text
        }
      );
    })());
  }
    ...
    return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement(
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("g", { style: { pointerEvents: "none" } }, /* @__PURE__ */ React.createElement(
        ...
        HoverInfo,
        {
          ...
          vw,
          vh,
          title: partInfo("flue_pipe", lang).title,
          text: partInfo("flue_pipe", lang).text,
          ringPath: flueD,
  ...
  function AirHandlerH({ x, y, w, h, active, auxHeat, evapC, evapC2, hasUV, acoilInfoKey, blowerActive, blowerMotorLabel, refReversed, onEditStep, lang, vw, vh }) {
    ...
    return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement(
      HoverInfo,
      {
        ...
        vw,
        vh,
        title: partInfo("air_handler_cabinet", lang).title,
        text: partInfo("air_handler_cabinet", lang).text,
        onClick: onEditStep ? () => onEditStep("indoor_type") : void 0
      }
    ), /* @__PURE__ */ React.createElement(
      "rect",
  ...
  function RegisterGrille({ cx, y, w, dc, ds, label, lang, vw, vh }) {
    ...
    return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement("rect", { x: cx - w / 2, y, width: w, height: h, rx: "1.5", fill: "rgba(0,0,0,.78)", stroke: dc, strokeWidth: "1.2" }), /* @__PURE__ */ React.createElement("line", { x1: cx - w / 2 + 2, y1: y + 1, x2: cx + w / 2 - 2, y2: y + 1, stroke: "rgba(255,255,255,.16)", strokeWidth: "0.6" }), Array.from({ length: 5 }, (_, j) => {
      ...
      HoverInfo,
      {
        ...
        vw,
        vh,
        title: partInfo("supply_register", lang).title,
        text: partInfo("supply_register", lang).text,
    ...
    return /* @__PURE__ */ React.createElement("g", null, boxes.map((type, i) => {
      ...
      return /* @__PURE__ */ React.createElement("g", { key: type, className: snap ? "snap" : void 0, style: snap ? { animationDelay: 0.32 + i * 0.05 + "s" } : void 0 }, isDehu ? /* @__PURE__ */ React.createElement(React.Fragment, null, hangKit(r1X, ry, "#22c55e"), hangKit(r2X, ry, "#22c55e")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("rect", { x: pipe1X - 2, y: ry, width: 5, height: Math.max(0, BY - ry), rx: "1", fill: B + ".3)", stroke: B + ".5)", strokeWidth: "0.8" }), /* @__PURE__ */ React.createElement("rect", { x: pipe1X - 5, y: ry - 4, width: "11", height: 5, rx: "1", fill: B + ".35)", stroke: B + ".55)", strokeWidth: "0.8" }), /* @__PURE__ */ React.createElement("text", { x: pipe1X, y: ry - 6, textAnchor: "middle", fill: B + ".6)", fontSize: "12", fontFamily: "monospace" }, "IN"), /* @__PURE__ */ React.createElement("rect", { x: pipe2X - 2, y: ry, width: 5, height: Math.max(0, BY - ry), rx: "1", fill: "rgba(249,115,22,.3)", stroke: "rgba(249,115,22,.5)", strokeWidth: "0.8" }), /* @__PURE__ */ React.createElement("path", { d: "M" + (pipe2X - 4) + " " + (ry - 2) + " L" + pipe2X + " " + (ry - 9) + " L" + (pipe2X + 4) + " " + (ry - 2), fill: "rgba(249,115,22,.4)" }), /* @__PURE__ */ React.createElement("text", { x: pipe2X, y: ry - 11, textAnchor: "middle", fill: "rgba(249,115,22,.6)", fontSize: "12", fontFamily: "monospace" }, "OUT"), hangKit(r1X, ry, G + ".55)"), hangKit(r2X, ry, G + ".55)")), /* @__PURE__ */ React.createElement(
        ...
        HoverInfo,
        {
          ...
          vw,
          vh,
          title: partInfo(isDehu ? "dehu_box" : "erv_box", lang).title,
          text: partInfo(isDehu ? "dehu_box" : "erv_box", lang).text
        }
      ));
    }));
  }
  ...
  function Canvas({ a, stepIdx, activeSteps, onEditStep, lang }) {
    ...
    if (isAttic) {
      ...
      return /* @__PURE__ */ React.createElement(HoverCtx.Provider, { value: setHoverPart }, /* @__PURE__ */ React.createElement(GroupCtx.Provider, { value: groupApi }, /* @__PURE__ */ React.createElement("div", { ref: wrapRef, style: { position: "absolute", inset: 0 } }, hasCoil && /* @__PURE__ */ React.createElement(ToggleUI, { style: { position: "absolute", top: 8, right: 8, zIndex: 10 }, compactToggle, isDualFuel, hasFurnace, heatMode, heatSubMode, setHeatMode, setHeatSubMode, monthName: CURRENT_MONTH_NAME }), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${VW} ${VH}`, preserveAspectRatio: "xMidYMid meet", className: "canvas-svg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement(Defs, null), /* @__PURE__ */ React.createElement("rect", { x: "0", y: "0", width: VW, height: VH, fill: "#0b0d14" }), hasCond && /* @__PURE__ */ React.createElement(
        ...
        const FAN = 36;
        const grille = (cx) => /* @__PURE__ */ React.createElement(RegisterGrille, { cx, y: DECK_Y, w: GW, dc: DC, ds: DS, label: "SUPPLY", lang, vw: SVG_VW, vh: SVG_VH });
    ...
    if (isCloset) {
      ...
      return /* @__PURE__ */ React.createElement(HoverCtx.Provider, { value: setHoverPart }, /* @__PURE__ */ React.createElement(GroupCtx.Provider, { value: groupApi }, /* @__PURE__ */ React.createElement("div", { ref: wrapRef, style: { position: "absolute", inset: 0 } }, hasCoil && /* @__PURE__ */ React.createElement(ToggleUI, { style: { position: "absolute", top: 8, right: 8, zIndex: 10 }, compactToggle, isDualFuel, hasFurnace, heatMode, heatSubMode, setHeatMode, setHeatSubMode, monthName: CURRENT_MONTH_NAME }), /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${VW} ${VH}`, className: "canvas-svg", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement(Defs, null), /* @__PURE__ */ React.createElement("rect", { x: "0", y: "0", width: VW, height: VH, fill: "#0b0d14" }), hasCond && /* @__PURE__ */ React.createElement(
        ...
        ), /* @__PURE__ */ React.createElement(RegisterGrille, { cx: rightDropX + DW / 2, y: DECK_Y, w: GW, dc: DC, ds: DS, label: "SUPPLY", lang, vw: SVG_VW, vh: SVG_VH }));
  ...
  function App() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "site-header-spacer no-print" }), /* @__PURE__ */ React.createElement("div", { ref: topRef, className: "app-root" }, /* @__PURE__ */ React.createElement("div", { "aria-live": "polite", "aria-atomic": "true", className: "sr-only" }, liveMessage), resumePending && /* @__PURE__ */ React.createElement("div", { className: "fadein", style: { position: "absolute", inset: 0, zIndex: 40, background: "var(--bk)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, padding: 24, textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { className: "splash-logo", style: { fontSize: "clamp(28px,6vw,44px)" } }, tr("WELCOME BACK", "BIENVENIDO DE NUEVO")), /* @__PURE__ */ React.createElement("p", { style: { fontFamily: "var(--fb)", fontSize: 15, color: "rgba(255,255,255,.6)", maxWidth: 420, lineHeight: 1.6 } }, (() => {
