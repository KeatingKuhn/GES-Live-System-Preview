...
(() => {
  ...
  var OPTS_ES = {
    ...
    dehu: {
      dehu: { label: "Deshumidificador para Toda la Casa", desc: "Calculado seg\xFAn el tama\xF1o de su casa, funciona autom\xE1ticamente. Sin mantenimiento." },
  ...
  function App() {
    ...
    const makeOpt = (opt, isSmall) => {
      ...
      if (isSmall) {
        return /* @__PURE__ */ React.createElement("button", { key: opt.v, className: "attic-opt" + (isOn ? " sel" : "") + (isDisabled ? " disabled" : ""), onClick: click }, /* @__PURE__ */ React.createElement("span", { className: "attic-opt-label" }, opt.label, opt.badge && /* @__PURE__ */ React.createElement("span", { className: "opt-badge" }, "GES")), /* @__PURE__ */ React.createElement("span", { className: "attic-opt-desc" }, opt.desc || ""), /* @__PURE__ */ React.createElement("div", { className: "attic-opt-foot" }, /* @__PURE__ */ React.createElement("div", { className: "attic-chk" + (isMulti ? "" : " radio") }, isMulti && isOn ? "\u2713" : "", !isMulti && isOn ? /* @__PURE__ */ React.createElement("div", { style: { width: 7, height: 7, borderRadius: "50%", background: "var(--gh)" } }) : "")));
      }
